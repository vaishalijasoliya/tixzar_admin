        ...
        <>
            <Grid container className={styles.listcontenatlogin}>
                <Grid item md={5} sm={8} className={styles.listgrifanfbox}>
                    <Box className={styles.listboxmailtext22}><Typography>Create new password</Typography></Box>
                    ...
                    <Box className={styles.listinputbox}>
                        ...
                        <form>
                            ...
                            <Typography className={styles.listemailtext}>Retype Password</Typography>
                            <Box style={{ display: 'flex' }}>
                                <TextField
                                    error={Boolean(
