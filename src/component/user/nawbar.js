...
const home = (props) => {
  ...
  const buttons = [
    ...
    <Button onClick={(() => { router.push('./Manage_Details') })} className={currentPath == '/Manage_Details' ||currentPath =='/Manage_Movie_details' ? styles.active : ""} key="one" variant="outlined" id={styles.butgri} ><MovieIcon className={styles.iconside} /><span className={styles.btndtl4}>Manage Movie Details</span></Button>,
