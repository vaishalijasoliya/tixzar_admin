    ...
    return (
        <Grid container className={styles.listcontenatlogin}>
            <Grid item md={5} sm={8} className={styles.listgrifanfbox}>
                <Box className={styles.listboxmailtext}><Typography>Check your mail</Typography></Box>
                ...
                <Box className={styles.listbuttomopen}><Button>Open Email</Button></Box>
                <Box className={styles.ategandperegaf}>
                    <a href="/dashboard" className={styles.listskipanda}>Skip</a>
